...
#define MAX_APPLICATION_SPEED_RPM           15804 /*!< rpm, mechanical */
...
#define PID_TORQUE_KP_DEFAULT               2211
#define PID_TORQUE_KI_DEFAULT               3537
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 2211
#define PID_FLUX_KI_DEFAULT                 3537
...
#define PID_SPEED_KI_DEFAULT                772/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define OV_VOLTAGE_THRESHOLD_V              13 /*!< Over-voltage threshold */
...
#define PHASE3_FINAL_SPEED_UNIT             (3492*SPEED_UNIT/U_RPM)
#define PHASE3_FINAL_CURRENT_A              5

/* Phase 4 */
#define PHASE4_DURATION                     0 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT             (3492*SPEED_UNIT/U_RPM)
#define PHASE4_FINAL_CURRENT_A              5

/* Phase 5 */
#define PHASE5_DURATION                     0 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT             (3492*SPEED_UNIT/U_RPM)
...
#define OBS_MINIMUM_SPEED_RPM               3143
